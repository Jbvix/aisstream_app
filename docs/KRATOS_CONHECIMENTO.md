...
| 18 | **Normas locais (NPCP-RJ)** | `KRATOS_NPCP_KNOWLEDGE` (prompt) | conhecimento estratégico da **NPCP-RJ (3ª Revisão, Mod.2)** completa (6 capítulos, ZP-15) + Portarias CPRJ nº 11 e nº 110/2026: **escada de reboque por porte** (LOA/boca/calado/DWT → nº de rebocadores e TTE mínimo), terminais de alta demanda (gusa, TECON grandes, petróleo, gás/LNGC, Angra/TPAR), onde o DP dispensa reboque, janelas de maré/vento, restrições diurno/noturno e calado/LOA por canal, fundeadouros, VHF e praticagem (ERU/ZP-15). Detalhe em `docs/conhecimento/npcp-rj-3rev-resumo-estrategico.md` e `npcp-rj-portarias-2026.md`; fonte integral em `docs/conhecimento/fontes/`. |
