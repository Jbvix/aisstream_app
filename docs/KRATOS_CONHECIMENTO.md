...
| 18 | **Normas locais (NPCP-RJ)** | `KRATOS_NPCP_KNOWLEDGE` (prompt) | conhecimento estratégico da NPCP-RJ (3ª Rev., Mod.2) + Portarias CPRJ nº 11 e nº 110/2026, **com foco na Baía de Guanabara, terminal a terminal**: exigência de rebocadores (nº/tipo/TTE) por porte em Gamboa, São Cristóvão, TECON-RJ (escada até 349 m), Terminal de Óleo, Alte. Tamandaré (PP/PS), GLP TAIC/TAIR, GNL, Manguinhos, Neolubes, Niterói/Caju (dispensas DP), estaleiros (EISA/Mauá) e ferro-gusa; janelas diurno/maré, carga perigosa, praticagem. Fichas em `docs/conhecimento/npcp-rj-bg-terminais.md`; demais subzonas da ZP-15 só como contexto. |
